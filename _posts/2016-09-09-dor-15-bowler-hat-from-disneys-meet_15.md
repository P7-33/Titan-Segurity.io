---
title: 'DOR-15 Bowler Hat from Disney’s Meet the
Robinsons @Raspberry_Pi #PiDay #RaspberryPi'
date: 2019-11-15T09:01:00+01:00
draft: false
---

![](https://cdn-blog.adafruit.com/uploads/2019/11/doris-600x449.gif)

via

For me, one of the stand-out characters of _Meet the Robinsons_ is DOR-15, a best-of-intentions experiment gone horribly wrong. Designed as a helper hat, DOR-15 instead takes over the mind of whoever is wearing it, hellbent on world domination.

Built using a Raspberry Pi and the [MATRIX Voice](https://www.matrix.one/products/voice) development board, the real-life DOR-15, from Team MATRIX Labs, may not be ready to take over the world, but it’s still really cool.
