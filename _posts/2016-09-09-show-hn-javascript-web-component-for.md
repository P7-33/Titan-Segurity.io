---
title: 'Show HN: JavaScript web component for online spreadsheets'
date: 2020-01-09T01:17:00+01:00
draft: false
---

[![The JavaScript spreadsheet](https://camo.githubusercontent.com/9516198d13eef74733cf229eb8c94ddced6b58b9/68747470733a2f2f626f7373616e6f76612e756b2f74656d706c617465732f64656661756c742f696d672f6c6f676f2d6a657863656c2e706e67)](https://camo.githubusercontent.com/9516198d13eef74733cf229eb8c94ddced6b58b9/68747470733a2f2f626f7373616e6f76612e756b2f74656d706c617465732f64656661756c742f696d672f6c6f676f2d6a657863656c2e706e67)

[**jExcel CE**](https://bossanova.uk/jexcel/v3/) is a lightweight Vanilla JavaScript plugin to create amazing web-based interactive HTML tables and spreadsheets compatible with Excel or any other spreadsheet software. You can create an online spreadsheet table from a JS array, JSON, CSV or XSLX files. You can copy from excel and paste straight to your jExcel CE spreadsheet and vice versa. It is very easy to integrate any third party JavaScript plugins to create your own custom columns, custom editors, and customize any feature into your application. jExcel CE has plenty of different input options through its native column types to cover the most common web-based application requirements. It is a complete solution for web data management. Create amazing applications with jExcel CE JavaScript spreadsheet.

[](https://github.com/paulhodel/jexcel/blob/master/README.md#main-advantages)Main advantages
--------------------------------------------------------------------------------------------
...
[](https://github.com/paulhodel/jexcel/blob/master/README.md#screenshot)Screenshot
----------------------------------------------------------------------------------

[![The JavaScript spreadsheet](https://camo.githubusercontent.com/dd9c2da2a4589eb6fd79fd41f23badde3d522b8f/68747470733a2f2f626f7373616e6f76612e756b2f74656d706c617465732f64656661756c742f696d672f6a657863656c2e676966)](https://camo.githubusercontent.com/dd9c2da2a4589eb6fd79fd41f23badde3d522b8f/68747470733a2f2f626f7373616e6f76612e756b2f74656d706c617465732f64656661756c742f696d672f6a657863656c2e676966)

[](https://github.com/paulhodel/jexcel/blob/master/README.md#installation)Installation
--------------------------------------------------------------------------------------
...
### [](https://github.com/paulhodel/jexcel/blob/master/README.md#basic-demo)Basic demo

A basic example to integrate the JavaScript spreadsheet in your website to create your first online spreadsheet.

```
<script src\="https://bossanova.uk/jexcel/v3/jexcel.js"\>script> <script src\="https://bossanova.uk/jsuites/v2/jsuites.js"\>script> <link rel\="stylesheet" href\="https://bossanova.uk/jsuites/v2/jsuites.css" type\="text/css" /> <link rel\="stylesheet" href\="https://bossanova.uk/jexcel/v3/jexcel.css" type\="text/css" />
```
...
[](https://github.com/paulhodel/jexcel/blob/master/README.md#examples)Examples
------------------------------------------------------------------------------
...
[](https://github.com/paulhodel/jexcel/blob/master/README.md#jexcel-ce-history)jExcel CE History
------------------------------------------------------------------------------------------------

jExcel CE v3 is a complete rebuilt JavaScript Vanilla version. For that reason it was not possible to keep a complete compatibility with the previous version. If you are upgrating you might need to implement a few updates in your code. If you have questions, you can review the article upgrating from jExcel CE v2 or Handsontable.

### [](https://github.com/paulhodel/jexcel/blob/master/README.md#jexcel-ce-301)Jexcel CE 3.0.1
...
### [](https://github.com/paulhodel/jexcel/blob/master/README.md#jexcel-ce-210)Jexcel CE 2.1.0
...
### [](https://github.com/paulhodel/jexcel/blob/master/README.md#jexcel-ce-200)Jexcel CE 2.0.0
...
### [](https://github.com/paulhodel/jexcel/blob/master/README.md#jexcel-ce-157)Jexcel CE 1.5.7

*   Checkbox column type improvements.
*   Destroy jQuery table updates.

### [](https://github.com/paulhodel/jexcel/blob/master/README.md#jexcel-ce-151)Jexcel CE 1.5.1

*   Spreadsheet data overflow and fixed headers. See an [example](https://github.com/paulhodel/jexcel/blob/master/jexcel/examples/table-with-fixed-headers).
*   Navigation improvements.

### [](https://github.com/paulhodel/jexcel/blob/master/README.md#jexcel-ce-150)Jexcel CE 1.5.0

*   Relative insertRow, deleteRow, insertColumn, deleteColumn. See an [example](https://github.com/paulhodel/jexcel/blob/master/jexcel/examples/working-with-the-data).
*   Redo, Undo action tracker for insertRow, deleteRow, insertColumn, deleteColumn, moveRow.
*   New formula column recursive chain.
*   New alternative design option bootstrap-like. See an [example](https://github.com/paulhodel/jexcel/blob/master/jexcel/examples/a-custom-table-design).
*   `updateSettings` updates.

[](https://github.com/paulhodel/jexcel/blob/master/README.md#officials-websites)Officials websites
--------------------------------------------------------------------------------------------------

[](https://github.com/paulhodel/jexcel/blob/master/README.md#community)Community
--------------------------------------------------------------------------------

[](https://github.com/paulhodel/jexcel/blob/master/README.md#compilation)Compilation
------------------------------------------------------------------------------------

To create a new distribution based on the source.

docker-compose up docker-compose exec bash php

% cd /bitnami/php-fpm/src % php compile.php

[](https://github.com/paulhodel/jexcel/blob/master/README.md#copyright-and-license)Copyright and license
--------------------------------------------------------------------------------------------------------

jExcel CE is released under the \[MIT license\]. Copyrights belong to Paul Hodel [paul.hodel@gmail.com](mailto:paul.hodel@gmail.com)

[](https://github.com/paulhodel/jexcel/blob/master/README.md#other-tools-by-the-author)Other tools by the author
----------------------------------------------------------------------------------------------------------------

  
  
from Hacker News https://github.com/paulhodel/jexcel/blob/master/README.md