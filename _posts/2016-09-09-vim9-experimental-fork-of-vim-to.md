---
title: 'Vim9: An experimental fork of Vim to explore making Vim script faster and better'
date: 2020-01-04T06:06:00+01:00
draft: false
---

[![Vim Logo](https://github.com/vim/vim/raw/master/runtime/vimlogo.gif)](https://github.com/vim/vim/blob/master/runtime/vimlogo.gif)

[](https://github.com/brammool/vim9/blob/master/README.md#what-is-vim9)What is Vim9?
====================================================================================

This is an experimental fork of [Vim](https://github.com/vim/vim). It explores ways of making Vim script faster and better.

WARNING: Do not use for daily work, it's likely to crash!

[](https://github.com/brammool/vim9/blob/master/README.md#why-vim9)Why Vim9?
============================================================================

[](https://github.com/brammool/vim9/blob/master/README.md#1-faster-vim-script)1\. FASTER VIM SCRIPT
---------------------------------------------------------------------------------------------------
...
How does Vim9 script work? The function is first compiled into a sequence of instructions. Each instruction has one or two parameters and a stack is used to store intermediate results. Local variables are also on the stack, space is reserved during compilation. This is a fairly normal way of compilation into an intermediate format, specialized for Vim, e.g. each stack item is a typeval\_T. And one of the instructions is "execute Ex command", for commands that are not compiled.

[](https://github.com/brammool/vim9/blob/master/README.md#2-phasing-out-interfaces)2\. PHASING OUT INTERFACES
-------------------------------------------------------------------------------------------------------------
...
Rationale: Why is it easier to run a tool separately from Vim than using a built-in interface and interpreter? Take for example something that is written in Python:
...
*   The Vim part is written in .vim files, the Python part is in .py files, this is nicely separated.
*   Disadvantage: An interface needs to be made between Vim and Python. JSON is available for this, and it's fairly easy to use. But it still requires implementing asynchronous communication.

[](https://github.com/brammool/vim9/blob/master/README.md#3-better-vim-script)3\. BETTER VIM SCRIPT
---------------------------------------------------------------------------------------------------
...
```
def MyFunction(arg: number): number let local \= 1 let todo \= arg const ADD \= 88 while todo > 0 local += ADD \--todo } return local enddef
```

Just some ideas, this will take time to design, discuss and implement. Eventually this will lead to Vim 9!

[](https://github.com/brammool/vim9/blob/master/README.md#code-for-sum-time-measurements)Code for sum time measurements
-----------------------------------------------------------------------------------------------------------------------
