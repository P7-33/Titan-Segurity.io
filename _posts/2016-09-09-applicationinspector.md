---
title: 'ApplicationInspector'
date: 2020-02-10T22:30:00+01:00
draft: false
---

**Kang Asu**

[![](https://1.bp.blogspot.com/-BoFdwvbTkDY/Xi5LXkpbyLI/AAAAAAAARg8/CUZVMFEu3jIt7E5XJGIhCYv0Xo6PpnCUQCNcBGAsYHQ/s640/ApplicationInspector_1.png)](https://1.bp.blogspot.com/-BoFdwvbTkDY/Xi5LXkpbyLI/AAAAAAAARg8/CUZVMFEu3jIt7E5XJGIhCYv0Xo6PpnCUQCNcBGAsYHQ/s1600/ApplicationInspector_1.png)
...
Be sure to see our project wiki page for more help [https://Github.com/Microsoft/ApplicationInspector/wiki](https://github.com/Microsoft/ApplicationInspector/wiki "https://Github.com/Microsoft/ApplicationInspector/wiki") for **illustrations** and additional information and help.  
...
**Usage**  
Application Inspector is a command-line tool. Run it from a [command line](https://www.kitploit.com/search/label/Command%20Line "command line") in Windows, Linux, or MacOS.
...
```
 Usage: dotnet AppInspector.dll analyze [arguments] [options]  
  ...
  -c, --confidence-filters      (Default: high,medium) Output only if matches rule pattern confidence [,] [high|medium|low]  
...
**[Download ApplicationInspector](http://homoluath.com/3XDB "Download ApplicationInspector")**
