---
title: 'Show HN: WindTerm 0.8 – A whole new generation of terminal emulator'
date: 2019-10-12T04:23:00+01:00
draft: false
---

[](https://github.com/kingToolbox/WindTerm#windterm)WindTerm
============================================================
...
[](https://github.com/kingToolbox/WindTerm#screenshots)Screenshots
==================================================================

[![WSL](https://github.com/kingToolbox/WindTerm/raw/master/images/screenshots/WSL.png)](https://github.com/kingToolbox/WindTerm/blob/master/images/screenshots/WSL.png) [![SplitView](https://github.com/kingToolbox/WindTerm/raw/master/images/screenshots/SplitView.png)](https://github.com/kingToolbox/WindTerm/blob/master/images/screenshots/SplitView.png)

[](https://github.com/kingToolbox/WindTerm#features)Features
============================================================
...
[](https://github.com/kingToolbox/WindTerm#shortcuts)Shortcuts
==============================================================
...
Toggle margin number

Alt+T, Alt+S

Toggle margin symbol
...
[](https://github.com/kingToolbox/WindTerm#performance)Performance
==================================================================
...
*   97.6MB random text (102,401,504 bytes, 1,329,878 lines, generated and tested by [random\_test.sh](https://github.com/kingToolbox/WindTerm/blob/master/benchmark/urandom_test.sh))
...
[](https://github.com/kingToolbox/WindTerm#latency)Latency
==========================================================

Considering the network influence on the latency, the following data is from [DIGEdit](https://github.com/kingToolbox/digedit). DIGEdit is the text component of WindTerm.
...
[](https://github.com/kingToolbox/WindTerm#license)License
==========================================================
