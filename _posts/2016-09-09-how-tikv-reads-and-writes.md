...
[![](https://tikv.org/img/blog/tikv-read-write/raft-process-in-tikv.png)](https://tikv.org/img/blog/tikv-read-write/raft-process-in-tikv.png)

Raft Process in TiKV
...
[![](https://tikv.org/img/blog/tikv-read-write/multiraft.png)](https://tikv.org/img/blog/tikv-read-write/multiraft.png)
...
[![](https://tikv.org/img/blog/tikv-read-write/region-routing.png)](https://tikv.org/img/blog/tikv-read-write/region-routing.png)

Region Routing in TiKV
...
[![](https://tikv.org/img/blog/tikv-read-write/rawkv-write.jpeg)](https://tikv.org/img/blog/tikv-read-write/rawkv-write.jpeg)
...
[![](https://tikv.org/img/blog/tikv-read-write/rawkv-read.jpeg)](https://tikv.org/img/blog/tikv-read-write/rawkv-read.jpeg)
...
[![](https://tikv.org/img/blog/tikv-read-write/txnkv-write.jpeg)](https://tikv.org/img/blog/tikv-read-write/txnkv-write.jpeg)

Write with TxnKV

For TxnKV, the situation is much more complicated. Most of the processes have been explained in the [Percolator](https://tikv.org/blog/how-tikv-reads-writes/#percolator) section. For TiKV to quickly seek the latest commit, the following steps are performed:
...
[![](https://tikv.org/img/blog/tikv-read-write/txnkv-read.jpeg)](https://tikv.org/img/blog/tikv-read-write/txnkv-read.jpeg)

Read with TxnKV

Refer to the [Percolator](https://tikv.org/blog/how-tikv-reads-writes/#percolator) section for detailed write process with the TxnKV.
...
```
Primary Key t_11_1-> (1, "a", 10, "hello") t_11_2-> (2, "b", 12, "world") Unique Name i_12_a-> 1 i_12_b-> 2 Index Age i_13_10_1-> nil i_13_12_2-> nil 
```
...
from Hacker News https://ift.tt/2Prkr8K