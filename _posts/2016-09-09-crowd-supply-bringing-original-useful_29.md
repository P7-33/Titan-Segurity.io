---
title: 'Crowd Supply – Bringing original, useful, respectful hardware to
life @crowd_supply #OHM2019 #oshwa @ohsummit #opensource #opensourcehardware @opensourceorg'
date: 2019-10-30T05:38:00+01:00
draft: false
---

![Crowdsupply](https://cdn-blog.adafruit.com/uploads/2019/10/crowdsupply.jpg)

A ton of great open hardware is always on [Crowd Supply](https://www.crowdsupply.com/), [we’ve covered it here on the Adafruit blog](https://blog.adafruit.com/2019/05/04/circuitpython-snakes-its-way-to-crowd-supply-for-the-greater-goods-crowd_supply-microchipmakes-circuitpython-circuitpython/), and for open hardware month, we reached out to ask what open hardware means to Crowd Supply.

![Crowdsupply10-29-19](https://cdn-blog.adafruit.com/uploads/2019/10/crowdsupply10-29-19.jpg)

First up – [what is Crowd Supply? From the about page](https://www.crowdsupply.com/about) –
...
> 
> Delivery is paramount, but we also care a lot about what gets delivered, which is why we have a [Proclamation of User Rights](https://www.crowdsupply.com/about#user-rights) to guide us.

![Adafruit 2019 2902](https://cdn-blog.adafruit.com/uploads/2019/10/adafruit_2019_2902.jpg)

Here’s a screenshot from one of the first instances that the Wayback machine saved from April 2013.

What does open hardware mean to Crowd Supply? [Josh](https://www.crowdsupply.com/team), Co-founder & President writes –

> While Crowd Supply isn’t the only company to realize that [open source hardware makes good business sense](https://www.linuxjournal.com/content/open-hardware-good-your-brand-good-your-bottom-line), we are uniquely positioned to leverage [the natural affinity](https://www.mouser.com/blog/a-combo-for-innovation-open-source-and-crowdfunding) [between open source hardware and crowdfunding](https://blog.crowdsupply.com/2017/05/02/crowdfunding-open-source-better-together/).
> 
> Open source hardware is central to Crowd Supply’s [mission](https://www.crowdsupply.com/about), which is basically about bringing to life products that don’t annoy, abuse, or trick their users. Whereas a lot of products on the market today have an adversarial relationship with users, open source hardware empowers users to learn and do new things. It fights for the user. This is very motivating for everyone who works at Crowd Supply!
> 
> From the perspective of Crowd Supply’s [business model](https://www.crowdsupply.com/launch), open source hardware helps our bottom line by building confidence among technically savvy early adopters that the product in question can be molded to their actual needs, regardless of the original intentions of the product creator or whether the product creator continues as a business. In nearly all cases, the value of a product is not the intellectual property, which is expensive to protect, but in the supply chain and community that  
> has grown around the product.

**Related:**

*   Crowd Supply [Blog](https://blog.crowdsupply.com/).
*   Crowd Supply on [Twitter @crowd\_supply](https://twitter.com/crowd_supply).
*   Crowd Supply on [Facebook](https://www.facebook.com/crowdsupply).
*   Crowd Supply on [Instagram @crowdsupply](https://www.instagram.com/crowdsupply/).
*   Crowd Supply on [YouTube](https://www.youtube.com/channel/UCEy6epGOpSspDO09v4IPRAw).
*   Crowd Supply on [Adafruit blog](https://blog.adafruit.com/?s=%40crowd_supply) and [video](https://youtu.be/uFwVdyHsP7Q).

Lastly, how did we miss this? [Mouser acquired Crowd Supply LAST YEAR](https://blog.crowdsupply.com/2018/10/03/crowd-supply-has-been-acquired/).
