---
title: 'Show HN: Chatistics – Turn Telegram, WhatsApp, Messenger Chatlogs to DataFrames'
...
![](https://github.com/MasterScrat/Chatistics/raw/master/static/cloud.png)![](https://github.com/MasterScrat/Chatistics/raw/master/static/cloud3.png)

### Changelog

**10 Jan 2020:** UPDATED _ALL_ THE THINGS! Thanks to [mar-muel](https://github.com/mar-muel) and [manueth](https://github.com/manueth), pretty much everything has been updated and improved, and **WhatsApp** is now supported!
...
A conversation ID, unique by platform

conversationWithName

Name of the other people in a direct conversation, **or** name of the group conversation
...
Boolean value whether the message is outgoing/coming from owner
...
Language of the conversation as inferred by [langdetect](https://pypi.python.org/pypi/langdetect)

platform

Platform (see support matrix above)
...
**Warning:** Facebook archives can take a _very_ long time to be ready for download - up to 12 hours! They can weight several gigabytes. Start with an archive containing just a few months of data if you want to quickly get started, this shouldn’t take more than a few minutes to complete.

1.  Go to the page “Your Facebook Information”: https://ift.tt/2xWDqjH
2.  Click on “Download Your Information”
3.  Select the date range you want. **The format _must_ be JSON.** Media won’t be used, so you can set the quality to “Low” to speed things up.
...
1.  Create your Telegram application to access chat logs ([instructions](https://core.telegram.org/api/obtaining_api_id)). You will need `api_id` and `api_hash` which we will now set as environment variables.
...
![](https://github.com/MasterScrat/Chatistics/raw/master/static/histo.png)

You can also plot the conversation densities using the `--as-density` flag.

![](https://github.com/MasterScrat/Chatistics/raw/master/static/densities.png)
...
from Hacker News https://ift.tt/2tr0aZV