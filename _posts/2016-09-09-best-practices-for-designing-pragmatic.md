...
... or just skip to the bottom and [**signup for updates**](https://www.vinaysahni.com/best-practices-for-a-pragmatic-restful-api#signup-for-updates)  

Latest from the Enchant blog

[How to make people fall in love with your app](https://www.enchant.com/blog/app-clarity)
...
[READ MORE →](https://www.enchant.com/blog/app-clarity)
...
An API that needs to support JSONP will need a third method of authentication, as JSONP requests cannot send HTTP Basic Auth credentials or Bearer tokens. In this case, a special query parameter access\_token can be used. Note: there is an inherent security issue in using a query parameter for the token as most web servers store query parameters in server logs.
...
from Hacker News https://ift.tt/2GYbXAw