...
date: 2019-10-31T03:32:00+01:00
draft: false
---
...
Why do fast ads matter? [#](https://web.dev/fast-ads-matter/#why-do-fast-ads-matter)
------------------------------------------------------------------------------------

### Fast ads improve the user experience [#](https://web.dev/fast-ads-matter/#fast-ads-improve-the-user-experience)
...
### Fast ads make you more money [#](https://web.dev/fast-ads-matter/#fast-ads-make-you-more-money)
...
![Chart showing latency injected vs. impressions change](https://web.dev/fast-ads-matter/ad-latency-injected-vs-impressions-change.svg)

Source: Google Internal Data, December 2016 to January 2017.

With 1 s of added delay, viewability rate decreased by 3.6% for mobile traffic and 2.9% for desktop traffic:

![Chart showing latency injected vs. viewability rate change](https://web.dev/fast-ads-matter/ad-latency-injected-vs-viewability-rate-change.svg)

Source: Google Internal Data, December 2016 to January 2017.

A framework for thinking about ad speed [#](https://web.dev/fast-ads-matter/#a-framework-for-thinking-about-ad-speed)
---------------------------------------------------------------------------------------------------------------------
...
### Know why you want to improve ad speed [#](https://web.dev/fast-ads-matter/#know-why-you-want-to-improve-ad-speed)
...
### Know your inventory and dependencies [#](https://web.dev/fast-ads-matter/#know-your-inventory-and-dependencies)
...
![An example workflow for the desktop leaderboard inventorytype.](https://web.dev/fast-ads-matter/desktop-leaderboard.svg)

While a more complex inventory type, such as mobile banner, may look like this:

![An example workflow for the mobile banner inventorytype.](https://web.dev/fast-ads-matter/mobile-banner.svg)
...
### Know where you want to improve [#](https://web.dev/fast-ads-matter/#know-where-you-want-to-improve)
...
The time it takes to load all ad libraries necessary to issue the first ad request. May be improved by removing or [delaying the loading of scripts](https://web.dev/efficiently-load-third-party-javascript/) that are not related to making ad requests.

Time to first ad request

The time elapsed from ad library load to the first ad request being made. May be improved by parallelizing header bidding requests and avoiding tasks that [block the main thread](https://web.dev/mainthread-work-breakdown/).
...
Conclusion [#](https://web.dev/fast-ads-matter/#conclusion)
-----------------------------------------------------------
...
Last updated: Oct 29, 2019 [Improve article](https://github.com/GoogleChrome/web.dev/blob/master/src/site/content/en/blog/fast-ads-matter/index.md)

  
  
from Hacker News https://ift.tt/2pr5GtG