---
title: 'Principles to help you design and deploy a zero trust architecture'
date: 2020-01-18T07:32:00+01:00
draft: false
---

![](https://avatars2.githubusercontent.com/u/11391831?s=400&v=4 "GitHub - ukncsc/zero-trust-architecture: Principles to help you design and deploy a zero trust architecture")  

[](https://github.com/ukncsc/zero-trust-architecture#zero-trust-architecture-design-principles)Zero trust architecture design principles
========================================================================================================================================
...
[](https://github.com/ukncsc/zero-trust-architecture#introduction)Introduction
------------------------------------------------------------------------------
...
[](https://github.com/ukncsc/zero-trust-architecture#what-does-this-guidance-do)What does this guidance do?
-----------------------------------------------------------------------------------------------------------
...
[](https://github.com/ukncsc/zero-trust-architecture#who-is-this-guidance-for)Who is this guidance for?
-------------------------------------------------------------------------------------------------------
...
[](https://github.com/ukncsc/zero-trust-architecture#terminology)Terminology
----------------------------------------------------------------------------
...
[](https://github.com/ukncsc/zero-trust-architecture#stay-nimble)Stay nimble
----------------------------------------------------------------------------
...
[](https://github.com/ukncsc/zero-trust-architecture#take-your-time)Take your time
----------------------------------------------------------------------------------
...
[](https://github.com/ukncsc/zero-trust-architecture#the-principles)The principles
----------------------------------------------------------------------------------

We then dive into the ten principles. These are the foundation of designing a zero trust architecture.

### [](https://github.com/ukncsc/zero-trust-architecture#1-know-your-architecture)1\. Know your architecture

In the zero trust network model it’s more important than ever to know about your assets.

[Read more](https://github.com/ukncsc/zero-trust-architecture/blob/master/1-know-your-architecture.md)

### [](https://github.com/ukncsc/zero-trust-architecture#2-create-a-single-strong-user-identity)2\. Create a single strong user identity

Your organisation should use a single user directory and create accounts that are linked to individuals.

[Read more](https://github.com/ukncsc/zero-trust-architecture/blob/master/2-create-a-single-strong-user-identity.md)

### [](https://github.com/ukncsc/zero-trust-architecture#3-create-a-strong-device-identity)3\. Create a strong device identity

Each device owned by your organisation should be uniquely identifiable in a single device directory.

[Read more](https://github.com/ukncsc/zero-trust-architecture/blob/master/3-create-a-strong-device-identity.md)

### [](https://github.com/ukncsc/zero-trust-architecture#4-authenticate-everywhere)4\. Authenticate everywhere

In a zero trust architecture assume the network is hostile, authenticate all connections.

[Read more](https://github.com/ukncsc/zero-trust-architecture/blob/master/4-authenticate-everywhere.md)

### [](https://github.com/ukncsc/zero-trust-architecture#5-know-the-health-of-your-devices-and-services)5\. Know the health of your devices and services

The health of devices and services is one of the most important signals used to gain confidence in them.

[Read more](https://github.com/ukncsc/zero-trust-architecture/blob/master/5-know-the-health-of-your-devices-and-services.md)

### [](https://github.com/ukncsc/zero-trust-architecture#6-focus-your-monitoring-on-devices-and-services)6\. Focus your monitoring on devices and services
...
[Read more](https://github.com/ukncsc/zero-trust-architecture/blob/master/6-focus-your-monitoring-on-devices-and-services.md)

### [](https://github.com/ukncsc/zero-trust-architecture#7-set-policies-according-to-the-value-of-services-or-data)7\. Set policies according to the value of services or data

The power of a zero trust architecture comes from the access policies you define.

[Read more](https://github.com/ukncsc/zero-trust-architecture/blob/master/7-set-policies-according-to-the-value-of-the-service-or-data.md)

### [](https://github.com/ukncsc/zero-trust-architecture#8-control-access-to-your-services-and-data)8\. Control access to your services and data

Each request to a service should be authorised against a policy.

[Read more](https://github.com/ukncsc/zero-trust-architecture/blob/master/8-control-access-to-your-services-and-data.md)

### [](https://github.com/ukncsc/zero-trust-architecture#9-dont-trust-the-network-including-the-local-network)9\. Don’t trust the network, including the local network

In order to remove trust from the network you need to build trust into the devices and services.

[Read more](https://github.com/ukncsc/zero-trust-architecture/blob/master/9-dont-trust-the-network.md)

### [](https://github.com/ukncsc/zero-trust-architecture#10-choose-services-designed-for-zero-trust)10\. Choose services designed for zero trust

Prefer services with built-in support for zero trust network architectures.

[Read more](https://github.com/ukncsc/zero-trust-architecture/blob/master/10-choose-services-designed-for-zero-trust.md)

  
  
from Hacker News https://ift.tt/2QUgviN