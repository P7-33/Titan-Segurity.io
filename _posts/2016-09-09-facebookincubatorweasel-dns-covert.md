---
title: 'Facebookincubator/Weasel: DNS Covert Channel Implant for Red Teams'
date: 2019-12-04T02:39:00+01:00
draft: false
---

![](https://avatars2.githubusercontent.com/u/19538647?s=400&v=4 "GitHub - facebookincubator/WEASEL: DNS covert channel implant for Red Teams.")  

[](https://github.com/facebookincubator/WEASEL#weasel-a-stealthy-dns-beacon)WEASEL: A Stealthy DNS Beacon
=========================================================================================================
...
*   Automatic obfuscation is lacking and needs manual fixing (see [Limitations in client README](https://github.com/facebookincubator/WEASEL/blob/master/client/README.md)).
*   Server does not have multi-player (simultaneous multiple operator) support.

[](https://github.com/facebookincubator/WEASEL#examples)Examples
----------------------------------------------------------------

See usage in [client's README](https://github.com/facebookincubator/WEASEL/blob/master/client/README.md) and [server's README](https://github.com/facebookincubator/WEASEL/blob/master/server/README.md) for specific instructions.
...
[](https://github.com/facebookincubator/WEASEL#requirements)Requirements
------------------------------------------------------------------------
...
The server has a few dependencies from pip, included in [server's requirements.txt](https://github.com/facebookincubator/WEASEL/blob/master/server/requirements.txt). The server should be run on Linux, but there is nothing preventing it from running on macOS or other \*nix.

[](https://github.com/facebookincubator/WEASEL#testing--running-in-development)Testing / Running in Development
---------------------------------------------------------------------------------------------------------------
...
[](https://github.com/facebookincubator/WEASEL#architecture)Architecture
------------------------------------------------------------------------
...
[](https://github.com/facebookincubator/WEASEL#persistence)Persistence
----------------------------------------------------------------------
...
[](https://github.com/facebookincubator/WEASEL#protocol-and-message-format)Protocol and Message Format
------------------------------------------------------------------------------------------------------

### [](https://github.com/facebookincubator/WEASEL#client-request)Client Request
...
#### [](https://github.com/facebookincubator/WEASEL#payload-encoding)Payload Encoding
...
### [](https://github.com/facebookincubator/WEASEL#server-response)Server Response
...
### [](https://github.com/facebookincubator/WEASEL#transport-format)Transport Format
...
Terminate yourself (server), terminating myself (client)

FIN

3

Initialization message (client)
...
Eval arbitrary Python3 code up to 666 bytes (server), returning first 400 bytes of output (client)

EVAL

python3 oneliner script

9

Execute arbitrary command up to 666 bytes (server), returning first 400 bytes of output (client)

EXEC

bash command

### [](https://github.com/facebookincubator/WEASEL#sessions)Sessions
...
### [](https://github.com/facebookincubator/WEASEL#encryption-badness)Encryption Badness
...
4.  We use os.urandom() for session ID and stream ID generation instead of a PRNG or UUID. In general urandom is a trustworthy enough source, but we are operating in a high level language on systems we can't trust.
5.  The AES-CTR cipher is re-initialized with the same IV (which is long lived like the session key) for every stream. This means that the same plaintext in the same position across streams will produce the same ciphertext.
6.  In AES-CTR the IV is correctly called a nonce, but in our implementation we aren't using the number once so it would be a bit rude to call it that.

### [](https://github.com/facebookincubator/WEASEL#streams)Streams
...
Streams are identified with a 2 byte random hex number. Recall the client request format is: `...domain.tld`
...
[](https://github.com/facebookincubator/WEASEL#join-the-weasel-community)Join the WEASEL community
--------------------------------------------------------------------------------------------------

See the [CONTRIBUTING](https://github.com/facebookincubator/WEASEL/blob/master/CONTRIBUTING.md) file for how to help out.

[](https://github.com/facebookincubator/WEASEL#license)License
--------------------------------------------------------------

WEASEL is MIT licensed, as found in the [LICENSE](https://github.com/facebookincubator/WEASEL/blob/master/LICENSE) file.

  
  
from Hacker News https://ift.tt/2OKSPML