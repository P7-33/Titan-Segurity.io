---
title: 'OLIMEX open-source hardware made in
Bulgaria @Olimex #OHM2019 #oshwa @ohsummit #opensource #opensourcehardware @opensourceorg @adafruit'
date: 2019-10-26T17:35:00+01:00
draft: false
---

![Logo](https://cdn-blog.adafruit.com/uploads/2019/10/logo.jpg)

Bulgaria based [OLIMEX](https://www.olimex.com/) has been one of the most prolific and inspiring open-source hardware manufacturers in our community. For well over 10+ years OLIMEX has not only designed, shipped, and shared open-source hardware, they have started specific advanced open-source efforts from open-source laptops to more recently, open-source IP cameras.

From the [OLIMEX about page](https://www.olimex.com/)…
...
Check out [OLinuXino – Open Source Hardware Boards](https://www.olimex.com/Products/OLinuXino/open-source-hardware) –
...
OLIMEX had an [open-source hardware month event](https://olimex.wordpress.com/2019/10/04/come-to-open-source-hardware-day-on-october-19th-in-plovdiv-and-learn-about-how-open-source-hardware-is-made/) [too!](https://ohm.oshwa.org/event/open-source-day/)

![Olimex Teresa64](https://cdn-blog.adafruit.com/uploads/2019/10/olimex_teresa64.jpg)

OLIMEX made an [open-source laptop](https://www.olimex.com/Products/DIY-Laptop/KITS/TERES-A64-BLACK/). TERES-I is do it yourself (DIY) free open-source hardware (FOSH) and free open-source software (FOSS) laptop kit. Ready-to-assemble using the instructions provided. KiCAD FOSS software is used to design all the hardware, schematics and board files available on their GitHub pages.

![Img2](https://cdn-blog.adafruit.com/uploads/2019/10/img2.jpg)

And recently, OLIMEX started worked on a new [IP Camera OSHW board](https://olimex.wordpress.com/2019/10/25/new-ip-camera-oshw-board-in-design-rfc/).

* * *

**Related:**

*   [OLIMEX](https://github.com/OLIMEX) – GitHub.
*   [OLIMEX on Twitter](https://twitter.com/Olimex) – @OLIMEX.
*   [OLIMEX](https://www.facebook.com/OLINUXINO/) on Facebook.
*   [Open Source Hardware (OSHW), why it matters and what is pseudo OSHW](https://olimex.wordpress.com/2016/01/13/open-source-hardware-oshw-why-it-matters-and-what-is-pseudo-oshw/) – OLIMEX.
*   [TERES I DIY Open Source Hardware Modular Hacker’s Laptop](https://olimex.wordpress.com/2016/08/31/teres-i-diy-open-source-hardware-hackers-laptop-update/) – OLIMEX.
*   [When One Project can be named Open Source Hardware?](https://olimex.wordpress.com/2014/07/15/when-one-project-can-be-named-open-source-hardware/) – OLIMEX.
...
from Adafruit Industries – Makers, hackers, artists, designers and engineers! https://ift.tt/343ALSU  
