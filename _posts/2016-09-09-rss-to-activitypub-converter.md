---
title: 'RSS to ActivityPub Converter'
date: 2019-11-07T05:37:00+01:00
draft: false
---

![](https://avatars3.githubusercontent.com/u/266454?s=400&v=4 "GitHub - dariusk/rss-to-activitypub: An RSS to ActivityPub converter.")  

[](https://github.com/dariusk/rss-to-activitypub#rss-to-activitypub-converter)RSS to ActivityPub Converter
==========================================================================================================

This is a server that lets users convert any RSS feed to an ActivityPub actor that can be followed by users on ActivityPub-compliant social networks like Mastodon. For a demo of this in action, see [https://bots.tinysubversions.com/convert/](https://bots.tinysubversions.com/convert/)
...
[](https://github.com/dariusk/rss-to-activitypub#requirements)Requirements
--------------------------------------------------------------------------
...
[](https://github.com/dariusk/rss-to-activitypub#installation)Installation
--------------------------------------------------------------------------
...
```
{ "DOMAIN": "mydomain.com", "PORT\_HTTP": "3000", "PORT\_HTTPS": "8443", "PRIVKEY\_PATH": "/path/to/your/ssl/privkey.pem", "CERT\_PATH": "/path/to/your/ssl/cert.pem" }
```
...
[](https://github.com/dariusk/rss-to-activitypub#sending-out-updates-to-followers)Sending out updates to followers
------------------------------------------------------------------------------------------------------------------
...
[](https://github.com/dariusk/rss-to-activitypub#local-testing)Local testing
----------------------------------------------------------------------------
...
[](https://github.com/dariusk/rss-to-activitypub#database)Database
------------------------------------------------------------------
...
### [](https://github.com/dariusk/rss-to-activitypub#accounts)`accounts`
...
### [](https://github.com/dariusk/rss-to-activitypub#feeds)`feeds`
...
[](https://github.com/dariusk/rss-to-activitypub#license)License
----------------------------------------------------------------
...
from Hacker News https://github.com/dariusk/rss-to-activitypub