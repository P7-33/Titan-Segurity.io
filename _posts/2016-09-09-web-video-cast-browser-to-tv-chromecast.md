...
Web Video CasterÂ® allows you to watch videos of your favorite websites on your TV, including movies, TV shows, live news feeds, sports and IPTV. It also allows you to stream local videos stored on your phone. Photos and audio files are also supported. Subtitles are detected on the web page, you can also use your own subtitles or you can use OpenSubtitles.org's built\*in search.
