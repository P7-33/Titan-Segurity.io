---
title: 'UPDATED GUIDE: 2.3″ Monochrome 128×32 OLED Display
Module @CircuitPython #Adafruit #AdafruitLearningSystem #Display @Raspberry_Pi @Adafruit'
date: 2019-11-12T01:56:00+01:00
draft: false
---

![](https://cdn-blog.adafruit.com/uploads/2019/11/blog_image_2.3.jpg)

The [2.3″ Monochrome 128×32 OLED Display Module](https://learn.adafruit.com/2-3-monochrome-128x32-oled-display-module) guide has been updated to include setup instructions for usage through User Python code on the Raspberry Pi using Blinka as well as use with CircuitPython.
...
[See this updated guide now](https://learn.adafruit.com/2-3-monochrome-128x32-oled-display-module)!

  
  
from Adafruit Industries – Makers, hackers, artists, designers and engineers! https://ift.tt/36P8z8B  
