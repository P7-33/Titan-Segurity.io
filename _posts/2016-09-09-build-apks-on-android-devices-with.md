...
```
 apt install curl curl -O https://raw.githubusercontent.com/BuildAPKs/buildAPKs/master/setup.buildAPKs.bash bash setup.buildAPKs.bash 
```
...
### [](https://github.com/BuildAPKs/buildAPKs#really-easily-build-an-android-apk-on-an-android-device-smartphone-and-tablet)Really Easily Build an Android APK on an Android Device (Smartphone and Tablet).
...
from Hacker News https://ift.tt/2tmkATG