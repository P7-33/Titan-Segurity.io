---
title: 'Detachable Sessions with Byobu on WSL'
...
![Check for byobu binary](https://www.brianketelsen.com/images/byobucheck.png)

Check to see if byobu is installed

Once installed it’s easy to start a session, just type the `byobu` command:

![new session](https://www.brianketelsen.com/images/byobuopen.png)
...
![a single byobu window](https://www.brianketelsen.com/images/byobunvim.png)

A single byobu window
...
![a second byobu window](https://www.brianketelsen.com/images/byobuwin.png)

A second byobu window
...
![a second byobu window](https://www.brianketelsen.com/images/byobusplit.png)
...
from Hacker News https://ift.tt/2AXBXe3