...
This is counter-intuitive: most people would think that if we’ve built, for example, a space ship or a complex airplane in the past, we could build it again at any time. But no, if we weren’t building a particular plane uninterruptedly, then after just 50 years it is already easier to develop a new one from scratch rather than trying to revive old processes and documentation. _Knowledge does not automatically transfer to the next generation._
...
![](https://tonsky.me/blog/good-times-weak-men/musicappcatalina.png)
...
from Hacker News https://ift.tt/2rJ9x6A